...
<div class="row">
    ...
    <h4 class="mt-0 header-title"> Add Photo Gallery </h4>
    <p class="text-muted m-b-30 font-14"> Fill all information below </p>
   
    <form class="sh-grid m-b-30" method="POST" action="{{ route('photo-gallery.store') }}"  enctype="multipart/form-data">
       {{ csrf_field() }}
    <div class="row">
    ...
    <label>Image</label> <br>
      <div class="custom-file">
       <input type="file" class="custom-file-input" id="image" name="photoGalleryImage[]" multiple>
