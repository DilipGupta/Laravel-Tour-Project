...
@section('title', ' | Add Package Categories')
...
<div class="row">
    ...
    <h4 class="mt-0 header-title"> Add Package Categories </h4>
    <p class="text-muted m-b-30 font-14"> Fill all information below </p>
   
    <form class="sh-grid m-b-30" method="POST" action="{{ route('package-categories.store') }}"  enctype="multipart/form-data">
       {{ csrf_field() }}
    <div class="row">
    ...
    <textarea class="form-control" name="short_description" id="description" rows="1">{{ old('description') }}</textarea>
    </div>
    </div>
    ...
    <label>Image</label> <br>
      <div class="custom-file">
       <input type="file" class="custom-file-input" id="image" name="packageCategoryImage">
