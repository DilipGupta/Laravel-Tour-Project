...
<div class="row">
    ...
    <form class="sh-grid m-b-30" method="POST" action="{{ route('testimonial.store') }}"  enctype="multipart/form-data">
       {{ csrf_field() }}
    <div class="row">
    <div class="col-sm-4 bord-grid">
        <div class="form-group">
        <label for="courcename">Name</label>
        <input id="name" name="name" type="text" class="form-control" value="{{ old('name') }}" required> 
        </div> 
    </div>
    <div class="col-sm-4 bord-grid">
        <div class="form-group">
        <label for="courcedesc">Testimonial</label>
        <textarea class="form-control" name="testimonial" id="testimonial" rows="1">{{ old('testimonial') }}</textarea>
        </div>
    </div>
    ...
    <label>Image</label> <br>
      <div class="custom-file">
       <input type="file" class="custom-file-input" id="image" name="testimonialImage">
